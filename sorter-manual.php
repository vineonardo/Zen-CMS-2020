				...
				<div class="uk-container uk-margin-large-top">
					<div class="uk-card uk-card-default uk-card-body">
						...
						<div class="uk-margin-medium-top uk-margin-bottom">
							<!-- search -->
							<div class="uk-margin">
								<form class="uk-search uk-search-default w100 uk-flex uk-flex-row">
							...
							<div class="uk-margin-medium uk-flex uk-flex-row uk-flex-between">
								...
								<div>
									<button class="uk-button uk-button-small uk-button-primary" type="button">Sections <span uk-icon="icon:chevron-down"></span></button>
									<div uk-dropdown>
								...
								<div>
									<button class="uk-button uk-button-small uk-button-primary" type="button">Article Type <span uk-icon="icon:chevron-down"></span></button>
									<div uk-dropdown>
									    <ul class="uk-nav uk-dropdown-nav">
									        <li class="uk-active"><a href="#">Active</a></li>
									        <li><a href="#">Item</a></li>
							...
							<div class="uk-grid uk-grid-small uk-grid-divider uk-grid-match">
								...
								<div class="uk-width-1-3 uk-margin-small-top">
									<div>
										<div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
											<div class="uk-card-header uk-flex uk-flex-middle uk-flex-between uk-text-small uk-padding-small">
												<h4 class="uk-h6 uk-margin-remove-top uk-margin-remove-bottom">Sections</h4>
												<a href="#" class="uk-link-reset">Clear <span uk-icon="icon:minus-circle;ratio:0.75"></span></a>
											</div>
											<div class="uk-card-body uk-padding-small">
												<div class="badges uk-flex uk-flex-row uk-flex-wrap">
													<a href="" class="uk-badge uk-badge-default uk-badge-close">Kolkata <span uk-icon="icon:minus-circle;ratio:0.8"></span></a>

													<a href="" class="uk-badge uk-badge-default uk-badge-close">Entertainment <span uk-icon="icon:minus-circle;ratio:0.8"></span></a>
										...
										<div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded uk-margin-top">
											<div class="uk-card-header uk-flex uk-flex-middle uk-flex-between uk-text-small uk-padding-small">
												<h4 class="uk-h6 uk-margin-remove-top uk-margin-remove-bottom">Article Type</h4>
												<a href="#" class="uk-link-reset">Clear <span uk-icon="icon:minus-circle;ratio:0.75"></span></a>
											</div>
											<div class="uk-card-body uk-padding-small">
												<div class="badges uk-flex uk-flex-row uk-flex-wrap">
													<a href="" class="uk-badge uk-badge-default uk-badge-close">Regular Article <span uk-icon="icon:minus-circle;ratio:0.8"></span></a>

													<a href="" class="uk-badge uk-badge-default uk-badge-close">Photo Story Article <span uk-icon="icon:minus-circle;ratio:0.8"></span></a>
								...
								<div class="uk-width-1-3 uk-margin-small-top">
									<ul class="output-list">
										<li class="uk-grid uk-grid-collapse uk-grid-match uk-margin-bottom uk-box-shadow-small">
											<div class="w10 uk-background-green uk-flex uk-flex-middle uk-flex-center uk-text-bold uk-text-center"><span class="uk-h4 uk-margin-remove">1</span></div>
											<div class="w90">
												<div class="uk-padding-small">
													<a href="#" class="uk-link-reset uk-text-bold uk-h5 uk-margin-bottom uk-margin-remove-top">IIT Mumbai 'gag' on protests</a>
										...
										<li class="uk-grid uk-grid-collapse uk-grid-match uk-margin-bottom uk-box-shadow-small">
											<div class="w10 uk-background-green uk-flex uk-flex-middle uk-flex-center uk-text-bold uk-text-center"><span class="uk-h4 uk-margin-remove">2</span></div>
											<div class="w90">
												<div class="uk-padding-small">
													<a href="#" class="uk-link-reset uk-text-bold uk-h5 uk-margin-bottom uk-margin-remove-top">Kangana Runout makes another narcist movie, Rangoli says it deserves oscar</a>
